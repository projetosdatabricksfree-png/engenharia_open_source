...
/*
  Mart final para BI: previsoes das proximas partidas enriquecidas
  com nomes dos clubes, ELO e contexto de tabela.
*/

with previsoes as (
    select * from {{ source('diamond_raw', 'previsoes_proximas_partidas') }}
),
